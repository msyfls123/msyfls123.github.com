...
\newcommand{\tips}{\textcolor[rgb]{0.4,0.4,0.4}}
% 显示索引号;仅用于在简历中使用了引言
%\makeatletter
...
\cventry{2014.7-8}{前端开发}{\high{武汉七彩马科技有限公司}}{}{}{
\begin{itemize}
\item 静态展示页面的设计与制作
...
\cvitem{前端开发}{\small{熟练开发符合W3C、兼容性及响应式要求的页面
		\begin{description}
			...
			\item[\high{工程化}]{会应用Gulp/webpack等打包工具管理项目中依赖的js/scss/img等资源，实现单页面应用}
			\item[\high{黑魔法}]{全景播放器Krpano，会它的一点点xml语法，能实现简单的交互}
		\end{description}}}
\cvitem{基础技能}{用git/svn进行版本管理，npm做node包管理，linux下简单操作，vim会保存退出...}
